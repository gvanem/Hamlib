...
declare_proto_rot(set_level)
{
    ...
    {
        char s[SPRINTF_MAX_SIZE];
        rot_sprintf_level(s, sizeof(s), HAMLIB_ROTSTATE(rot)->has_set_level);
        fputs(s, fout);
    ...
    if (!strcmp(arg2, "?"))
    {
        const gran_t *gran = HAMLIB_ROTSTATE(rot)->level_gran;
...
declare_proto_rot(get_level)
{
    ...
    {
        char s[SPRINTF_MAX_SIZE];
        rot_sprintf_level(s, sizeof(s), HAMLIB_ROTSTATE(rot)->has_get_level);
        fputs(s, fout);
...
declare_proto_rot(set_func)
{
    ...
    {
        char s[SPRINTF_MAX_SIZE];
        rot_sprintf_func(s, sizeof(s), HAMLIB_ROTSTATE(rot)->has_set_func);
        fprintf(fout, "%s\n", s);
        return RIG_OK;
    }
...
declare_proto_rot(get_func)
{
    ...
    {
        char s[SPRINTF_MAX_SIZE];
        rot_sprintf_func(s, sizeof(s), HAMLIB_ROTSTATE(rot)->has_get_func);
        fprintf(fout, "%s\n", s);
        return RIG_OK;
    }
...
declare_proto_rot(set_parm)
{
    ...
    {
        char s[SPRINTF_MAX_SIZE];
        rot_sprintf_parm(s, sizeof(s), HAMLIB_ROTSTATE(rot)->has_set_parm);
        fprintf(fout, "%s\n", s);
        return RIG_OK;
    }
...
declare_proto_rot(get_parm)
{
    ...
    {
        char s[SPRINTF_MAX_SIZE];
        rot_sprintf_parm(s, sizeof(s), HAMLIB_ROTSTATE(rot)->has_get_parm);
        fprintf(fout, "%s\n", s);
        return RIG_OK;
    }
...
declare_proto_rot(dump_state)
{
    struct rot_state *rs = HAMLIB_ROTSTATE(rot);
    char *tag;
...
{
    int retval;
    hamlib_port_t *rotp = HAMLIB_ROTPORT(rot);
