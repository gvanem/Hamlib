...
{
    {
        TOK_FLRIG_VERIFY_FREQ, "VERIFY_FREQ", "Verify set_freq", "If true will verify set_freq otherwise is fire and forget", "0", RIG_CONF_CHECKBUTTON, { 0 }
    },
    {
        TOK_FLRIG_VERIFY_PTT, "VERIFY_PTT", "Verify set_ptt", "If true will verify set_ptt otherwise set_ptt is fire and forget", "0", RIG_CONF_CHECKBUTTON, { 0 }
    },
    { RIG_CONF_END, NULL, }
};
...
static int flrig_set_func(RIG *rig, vfo_t vfo, setting_t func,
                                  int status)
{
    int retval;
    char cmd_arg[MAXARGLEN];
