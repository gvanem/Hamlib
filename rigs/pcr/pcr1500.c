/*
 *  Hamlib PCR backend - PCR-1500 description
...
#define PCR1500_MODES_WIDE ( RIG_MODE_AM | RIG_MODE_FM | RIG_MODE_WFM )
 ...
 */
const struct rig_caps pcr1500_caps =
{
    RIG_MODEL(RIG_MODEL_PCR1500),
    .model_name     = "IC-PCR1500",
    .mfg_name       = "Icom",
    ...
    .has_set_func       = PCR1500_FUNC,
    .has_get_level      = PCR1500_LEVEL,
    .has_set_level      = RIG_LEVEL_SET(PCR1500_LEVEL),
    ...
    .rx_range_list1 = {
        { kHz(495), GHz(1.3), PCR1500_MODES_NAR,  -1, -1, RIG_VFO_A},
        { kHz(10), GHz(3.3) - kHz(1), PCR1500_MODES_WIDE, -1, -1, RIG_VFO_A},
        RIG_FRNG_END
    },
    ...
    .rx_range_list2 = {
        ...
        { MHz(894) + 10, GHz(1.3), PCR1500_MODES_NAR, -1, -1, RIG_VFO_A },

        { kHz(10), MHz(824) - 10, PCR1500_MODES_WIDE, -1, -1, RIG_VFO_A },
        { MHz(849) + 10, MHz(869) - 10, PCR1500_MODES_WIDE, -1, -1, RIG_VFO_A },
        { MHz(894) + 10, GHz(3.3) - kHz(1), PCR1500_MODES_WIDE, -1, -1, RIG_VFO_A },
        RIG_FRNG_END
    },
