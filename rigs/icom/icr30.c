...
{
    { TOK_ANL, "anl", "Auto noise limiter", "", "", RIG_CONF_CHECKBUTTON, { 0 } },
    { TOK_EAR, "ear", "Earphone mode", "", "", RIG_CONF_CHECKBUTTON, { 0 } },
    { TOK_REC, "record", "Recorder on/off", "", "", RIG_CONF_CHECKBUTTON, { 0 } },
    { 0 }
};
